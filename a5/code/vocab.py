...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        def mark(c):
            ...
            return c
        return [[mark([self.char2id[c] for c in w]) for w in s] for s in sents]
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        # Reshape from (batch_size, max_sentence_length, max_word_length)
        # to (max_sentence_length, batch_size, max_word_length)
